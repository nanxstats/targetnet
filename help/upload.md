To run TargetNet for multiple compounds at once, upload the compound(s) stored in [SMILES](http://www.daylight.com/smiles/) or [SD/SDF](http://en.wikipedia.org/wiki/SD_format) files.
